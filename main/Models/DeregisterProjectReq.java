...
public class DeregisterProjectReq extends Request {
    ...
    public void processRequest(String decision) {
        ...
        if(decision.equals("APPROVE")){
            ...
            String newString2 = projectdata[0]+","+projectdata[1]+","+projectdata[2]+","+projectdata[3]+","+projectStatus_ENUM.AVAILABLE.toString()+","+"NaN"+","+"NaN";
            ...
            try{
                ...
                while((currentLine = br.readLine()) != null){
                    ...
                    if(currentLine.trim().length() > 0){
                        ...
                        if(lineData[2].equalsIgnoreCase(supervisor_email) && lineData[4].equalsIgnoreCase(projectStatus_ENUM.UNAVAILABLE.toString())){
                            currentLine = lineData[0]+","+lineData[1]+","+lineData[2]+","+lineData[3]+","+projectStatus_ENUM.AVAILABLE.toString()+","+lineData[5]+","+lineData[6];
                        }
